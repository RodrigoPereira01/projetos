...
<body>
    ...
    <main>
        <div class="titulo col-12">
            <div class="container">
                <h3 class="main-title">Usuários</h3>
            </div>
        </div>
        <div class="content pt-5">
            <?php
                ...
                $lista_usuarios = $obj->controlaConsulta();
            ?> 

            <?php if($lista_usuarios != -1){ ?>
                <div class="container-form">
                                ...
                                <?php foreach($lista_usuarios as $usuario){?>
                                    <tr>    
                                        ...
                                        <td class="text-center">
                                            <button type="button"  value="alterar" accesskey="<?php echo $usuario->codigo; ?>" class="alterar_usuario btn btn-info"><i class="fas fa-pen"></i></button>
                                            <button type="button"  value="excluir" accesskey="<?php echo $usuario->codigo; ?>" class="excluir_usuario btn btn-danger"><i class="far fa-trash-alt"></i></button>
                                        </td>    
                                    </tr>
                                <?php } ?>
                            </tbody>  
                    ...
                    <div class="create-button col-6">
                        <a href="../view/cadastroUsuario.php"><button type="button" class="btn btn-primary"><i class="fas fa-plus"></i>  Cadastrar novo usuário</button></a>
                    </div>
    ...
    <script src="../utils/js/usuario/listaUsuario.js"></script>
