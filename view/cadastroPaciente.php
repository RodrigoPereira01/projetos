...
<body>
                    ...
                    <form action='<?php echo isset($_GET["codigo"]) && is_numeric($_GET["codigo"]) ? "../controller/atualizaPaciente.php" : "../controller/inserePaciente.php";?>'
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nameId" name="nome" aria-describedby="name"
                                placeholder="Nome" value="<?php echo isset($paciente) ? $paciente[0]->nome : ""; ?>"  /><br>
                        </div>
                        <div class="form-group">
                            <label for="cpf">CPF:</label>
                            <input type="text" class="form-control" id="cpfId" name="cpf" maxlenght="14" autocomplete="off" placeholder="CPF" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="telefoneId" name="telefone"
                                ...
                                value="<?php echo isset($paciente) ? $paciente[0]->telefone : ""; ?>"  /><br>
                        </div>
    ...
    <script src="../utils/js/mascaras.js"></script>
